...
> NOTE: Difference between `useCallback` and `useMemo`. `useMemo` caches the
> RETURN VALUE OF THE FUNCTION while `useCallback` caches the FUNCTION ITSELF
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=02%3A%20useCallback%3A%20custom%20hooks&em=juanzitelli7%40gmail.com).
